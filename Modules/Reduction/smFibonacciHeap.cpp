...
//***************************************************************************
//=========================================================
// smFibonacciHeapNode Constructor
//=========================================================
//***************************************************************************

//smFibonacciHeapNode::smFibonacciHeapNode() {
//  Left = Right = Parent = Child = NULL;
//  Degree = Mark = NegInfinityFlag = 0;
//}

//=========================================================
// smFibonacciHeapNode Destructor
//
// Body is empty, but declaration is required in order to
// force virtual.  This will ensure that smFibonacciHeap class
...
//void smFibonacciHeapNode::FHN_Assign(smFibonacciHeapNode& RHS) {
...
//int  smFibonacciHeapNode::FHN_Cmp(smFibonacciHeapNode& RHS) {
//  if (NegInfinityFlag)
...
void smFibonacciHeapNode::operator =(smFibonacciHeapNode& RHS)
{
	this->FHN_Assign(RHS);
	// Key assignment goes here in derived classes
}

int  smFibonacciHeapNode::operator ==(smFibonacciHeapNode& RHS)
{
	if (this->FHN_Cmp(RHS)) return 0;
...
void smFibonacciHeapNode::Print()
{
	if (this->NegInfinityFlag)
		std::cout << "-inf.";
}

//***************************************************************************
//===========================================================================
// smFibonacciHeap Constructor
//===========================================================================
//***************************************************************************

smFibonacciHeap::smFibonacciHeap()
{
	this->MinRoot = NULL;
	this->NumNodes = this->NumTrees = this->NumMarkedNodes = 0;
	this->ClearHeapOwnership();
}

//===========================================================================
// smFibonacciHeap Destructor
//===========================================================================

smFibonacciHeap::~smFibonacciHeap()
{
	smFibonacciHeapNode *Temp;

	if (this->GetHeapOwnership())
    {
		while (this->MinRoot != NULL)
        {
			Temp = this->ExtractMin();
			delete Temp;
		}
	}
}
...
void smFibonacciHeap::Insert(smFibonacciHeapNode *NewNode)
{
	...
	if (this->MinRoot == NULL)
		this->MinRoot = NewNode->Left = NewNode->Right = NewNode;

	else {
		// Pointers from NewNode set to insert between MinRoot and MinRoot->Right

		NewNode->Right = this->MinRoot->Right;
		NewNode->Left = this->MinRoot;
		...
		if (*NewNode < *this->MinRoot)
			this->MinRoot = NewNode;
	}
...
void smFibonacciHeap::Union(smFibonacciHeap *OtherHeap)
{
	smFibonacciHeapNode *Min1, *Min2, *Next1, *Next2;
...
//smFibonacciHeapNode *smFibonacciHeap::Minimum() {
//  return MinRoot;
//}
...
smFibonacciHeapNode *smFibonacciHeap::ExtractMin()
{
	smFibonacciHeapNode *Result;
	smFibonacciHeap *ChildHeap = NULL;
	...
	else if (this->MinRoot == Result)
		this->MinRoot = Result->Child;
...
int  smFibonacciHeap::DecreaseKey(smFibonacciHeapNode *theNode, smFibonacciHeapNode& NewKey)
{
	smFibonacciHeapNode *theParent;
	...
	*theNode = NewKey;
    ...
    {
		this->_Cut(theNode, theParent);
		this->_CascadingCut(theParent);
	}
...
int  smFibonacciHeap::Delete(smFibonacciHeapNode *theNode)
{
	smFibonacciHeapNode Temp;
	int Result;
...
void smFibonacciHeap::Print(smFibonacciHeapNode *Tree, smFibonacciHeapNode *theParent)
{
	smFibonacciHeapNode* Temp = NULL;
...
//void smFibonacciHeap::_Exchange(smFibonacciHeapNode*& N1, smFibonacciHeapNode*& N2) {
//  smFibonacciHeapNode *Temp;
//  Temp = N1;
//  N1 = N2;
//  N2 = Temp;
...
void smFibonacciHeap::_Consolidate()
{
	smFibonacciHeapNode *x, *y, *w;
	smFibonacciHeapNode *A[1+8*sizeof(long)]; // 1+lg(n)
	...
	this->MinRoot->Left->Right = NULL;
	this->MinRoot->Left = NULL;
	w = MinRoot;
...
void smFibonacciHeap::_Link(smFibonacciHeapNode *y, smFibonacciHeapNode *x)
{
...
void smFibonacciHeap::_AddToRootList(smFibonacciHeapNode *x)
{
	if (x->Mark)
        this->NumMarkedNodes --;
	x->Mark = 0;
...
void smFibonacciHeap::_Cut(smFibonacciHeapNode *x, smFibonacciHeapNode *y)
{
	if (y->Child == x)
		y->Child = x->Right;
	if (y->Child == x)
...
void smFibonacciHeap::_CascadingCut(smFibonacciHeapNode *y)
{
	smFibonacciHeapNode *z = y->Parent;
